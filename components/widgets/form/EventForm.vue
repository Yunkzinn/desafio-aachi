<template>
  <v-card>
    <v-toolbar card prominent extended color="primary" dark="">
      <v-toolbar-title class="body-2">Cadastrar Nova Vaga</v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-card-text>
      <v-form v-model="valid" ref="form" lazy-validation>
        <v-layout row wrap>
          <v-flex lg12 sm12>
            <v-text-field label="Cargo" name="title" v-model="title">
            </v-text-field>
          </v-flex>
          <v-flex sm6 lg6>
            <v-menu
          ...
          <v-flex lg12 sm12>
            <v-text-field textarea label="Descrição">
            </v-text-field>
          </v-flex>                              
          <v-spacer></v-spacer>
        </v-layout>        
